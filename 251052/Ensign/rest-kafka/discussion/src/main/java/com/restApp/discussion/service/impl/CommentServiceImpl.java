...
public class CommentServiceImpl implements CommentService {
    ...
    public CommentServiceImpl(CommentRepository commentRepository, CommentMapper commentMapper,
            KafkaTemplate<String, CommentRequestTo> kafkaTemplate) {
    ...
    public CommentResponseTo create(CommentRequestTo request) {
        ...
        // Trigger moderation via Kafka
        kafkaTemplate.send("InTopic", String.valueOf(saved.getNewsId()), request);
    ...
    @Override
    public CommentResponseTo moderate(Long id, String country, CommentState state) {
        String effectiveCountry = country != null ? country : "undefined";
        return commentRepository.findByCountryAndId(effectiveCountry, id)
                .map(comment -> {
