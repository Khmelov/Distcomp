...
public class EditorRequestTo {
    ...
    private EditorRole role = EditorRole.CUSTOMER; // Значение по умолчанию

    // Конструкторы
    public EditorRequestTo() {}

    public EditorRequestTo(String login, String password, String firstname, String lastname, EditorRole role) {
        this.login = login;
