...
public class KafkaConfig {
    ...
    // Producer Factory для отправки объектов
    @Bean
    ...
    // Consumer Factory для получения объектов из OutTopic
    @Bean
    public ConsumerFactory<String, Object> consumerFactory() {
        ...
        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, "java.util.LinkedHashMap"); // Десериализуем как Map
