package org.example.task340.discussion.service.impl;
...
import org.example.task340.discussion.exception.NotFoundException;
import org.example.task340.discussion.exception.ValidationException;
import org.example.task340.discussion.mapper.MessageMapper;
import org.example.task340.discussion.model.Message;
import org.example.task340.discussion.repository.MessageRepository;
...
public class MessageServiceImpl implements MessageService {
    ...
    public MessageResponseTo create(MessageRequestTo request) {
        ...
        entity.setState(org.example.task340.discussion.model.MessageState.PENDING);
    ...
    private void validate(MessageRequestTo request) {
        ...
        if (!StringUtils.hasText(request.getCountry()) || request.getCountry().length() < 2 || request.getCountry().length() > 64) {
