...
@RestController
@RequestMapping({"/api/v1.0/posts", "/api/v1.0/comments"})
public class PostController {

    private final MockPostService service;

    public PostController(MockPostService service) {
    ...
    public ResponseEntity<PostResponse> getById(@PathVariable Long id) {
        return service.getById(id)
                ...
                .orElseGet(() -> ResponseEntity.status(HttpStatus.NOT_FOUND).body(new PostResponse()));
    }
