...
public class WriterService {
    ...
    public WriterService(WriterRepository repository, StickerRepository stickerRepository, PasswordEncoder passwordEncoder) {
    ...
    public WriterResponse create(WriterRequest request) {
        ...
        writer.setRole(WriterRole.CUSTOMER);
