package org.example.task350.discussion.controller;
...
public class MessageController {
    ...
    public MessageResponseTo getByIdLegacy(@PathVariable("id") Long id) {
        ...
        return allMessages.stream()
                ...
                .findFirst()
                .orElseThrow(() -> new org.example.task350.discussion.exception.NotFoundException("Message not found: " + id));
    }
    ...
    public MessageResponseTo updateLegacy(@PathVariable("id") Long id,
        ...
        // Set country and tweetId from found message if not provided in request
