...
public class LabelControllerTest extends RestTestBase {
    ...
    @Test
    @DisplayName("Check 403 CREATE with duplicate name Label")
    void createWithDuplicateName() {
        ensureRefs();
        String name = "duplicate-label";
        
        long id = createLabel(name);
    ...
    @Test
    @DisplayName("Regression check REST Label (Repeat all CRUD)")
    void regressionCheckAllCrud() {
        ensureRefs();
        String name = "regression-label";
