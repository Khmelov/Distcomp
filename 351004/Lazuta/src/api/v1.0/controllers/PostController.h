...
class PostController : public drogon::HttpController<PostController>
{
  public:
    ...
    // METHOD_ADD(PostController::get, "/{2}/{1}", Get); // path is /PostController/{arg2}/{arg1}
    // METHOD_ADD(PostController::your_method_name, "/{1}/{2}/list", Get); // path is /PostController/{arg1}/{arg2}/list
