...
class TblEditor
{
  public:
     ...
     */
    explicit TblEditor(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit TblEditor(const Json::Value &pJson) noexcept(false);
     ...
     */
    TblEditor(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<TblEditor>;
    friend drogon::orm::BaseBuilder<TblEditor, true, true>;
    friend drogon::orm::BaseBuilder<TblEditor, true, false>;
    friend drogon::orm::BaseBuilder<TblEditor, false, true>;
    friend drogon::orm::BaseBuilder<TblEditor, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<TblEditor>;
#endif
