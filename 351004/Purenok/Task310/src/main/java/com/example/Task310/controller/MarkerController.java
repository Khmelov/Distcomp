...
public class MarkerController {
    ...
    public MarkerResponseTo create(@Valid @RequestBody MarkerRequestTo request) { return service.create(request); }
    @GetMapping
    ...
    @PutMapping("/{id}")
    public MarkerResponseTo update(@PathVariable Long id, @Valid @RequestBody MarkerRequestTo request) { return service.update(id, request); }
    @DeleteMapping("/{id}")
