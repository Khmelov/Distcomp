...
public class MessageController {
    ...
    public ResponseEntity<MessageResponseTo> updateMessage(
        ...
        try {
            ...
            // Изменить обработку ошибки с 409 на другое поведение
            if (e.getMessage().contains("Cannot edit message")) {
                // Если все же хотим сохранить проверку, возвращаем более информативный ответ
    ...
    public ResponseEntity<Void> deleteMessage(@PathVariable("id") Long id) {
        ...
        try {
            ...
            deleteRequest.setTopicId(currentMessage.getTopicId()); // Используем реальный topicId!
