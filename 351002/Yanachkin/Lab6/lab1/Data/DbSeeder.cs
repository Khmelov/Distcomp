...
public static class DbSeeder
{
    ...
    {
        await EnsureEditorRoleColumnAsync(db, cancellationToken).ConfigureAwait(false);
    ...
    private static async Task EnsureEditorRoleColumnAsync(AppDbContext db, CancellationToken cancellationToken)
    {
        const string alterSql = """
            ALTER TABLE distcomp.tbl_editor
