...
public class EditorServiceImpl implements EditorService {
    ...
    public EditorResponseTo create(EditorRequestTo request) {
        ...
        if (editorRepository.existsByLogin(request.getLogin())) {
            throw new DuplicateResourceException("Editor with login '" + request.getLogin() + "' already exists");
        }
    ...
    public EditorResponseTo update(Long id, EditorRequestTo request) {
        ...
        if (!editor.getLogin().equals(request.getLogin()) &&
            ...
            throw new IllegalArgumentException("Editor with login '" + request.getLogin() + "' already exists");
        }
