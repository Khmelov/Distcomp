...
namespace Infrastructe.Repository.CassandraRepository
{
    public class CassandraCommentRepository : IRepository<Comment>
    {
        private readonly Cassandra.ISession _session;
        private readonly Cassandra.Mapping.IMapper _mapper;

        public CassandraCommentRepository(Cassandra.ISession session)
        {
            _session = session;
