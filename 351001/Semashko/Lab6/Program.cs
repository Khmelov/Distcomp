...
builder.Services
    ...
    .AddJwtBearer(opt =>
    {
        opt.TokenValidationParameters = JwtTokenService.BuildValidationParameters();
        opt.Events = new JwtBearerEvents
        {
            OnChallenge = context =>
            {
                ...
                return context.Response.WriteAsync("{\"errorMessage\":\"Unauthorized\",\"errorCode\":\"40100\"}");
            },
            OnForbidden = context =>
            {
                context.Response.StatusCode = StatusCodes.Status403Forbidden;
                context.Response.ContentType = "application/json";
                return context.Response.WriteAsync("{\"errorMessage\":\"Forbidden\",\"errorCode\":\"40300\"}");
            }
        };
    });
