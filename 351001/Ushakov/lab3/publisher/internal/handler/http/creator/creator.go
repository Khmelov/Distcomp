...
import (
	...
	creatorModel "github.com/Khmelov/Distcomp/351001/Ushakov/lab3/publisher/internal/model"
	creatorDbModel "github.com/Khmelov/Distcomp/351001/Ushakov/lab3/publisher/internal/storage/psql/creator"
...
func (c Creator) InitRoutes(r *mux.Router) {
	...
	r.HandleFunc("/authors", c.createCreator).Methods(http.MethodPost)
...
func (c Creator) deleteCreatorByID(w http.ResponseWriter, r *http.Request) {
	...
	_, _ = w.Write([]byte(`{"post": "Creator deleted successfully"}`))
}
