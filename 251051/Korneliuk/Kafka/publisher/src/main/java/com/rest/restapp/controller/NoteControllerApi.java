...
public interface NoteControllerApi {
    ...
    @PutMapping("/notes")
    ResponseEntity<NoteResponseTo> updateNote(@Valid @RequestBody NoteRequestTo requestTo);
    ...
    ResponseEntity<List<NoteResponseTo>> getNotesByIssueId(@PathVariable(name = "id") Long issueId);
}