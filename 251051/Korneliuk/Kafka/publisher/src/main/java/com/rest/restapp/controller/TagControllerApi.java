...
public interface TagControllerApi {
    ...
    @ApiResponse(responseCode = "200", description = "Get Tag")
    @GetMapping("/tags/{id}")
    ResponseEntity<TagResponseTo> getTagById(@PathVariable(name = "id") Long id);
    ...
    @PutMapping("/tags/{id}")
    ResponseEntity<TagResponseTo> updateTag(@PathVariable(name = "id") Long id,
