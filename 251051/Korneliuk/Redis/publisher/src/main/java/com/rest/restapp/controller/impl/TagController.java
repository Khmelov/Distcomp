...
public class TagController implements TagControllerApi {
    ...
    @Override
    public ResponseEntity<TagResponseTo> createTag(TagRequestToDto requestTo) {
    ...
    @Override
    public ResponseEntity<TagResponseTo> updateTag(Long id, TagRequestToDto requestTo) {
