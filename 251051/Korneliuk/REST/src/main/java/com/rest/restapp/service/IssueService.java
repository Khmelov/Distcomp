...
public class IssueService {
    ...
    public IssueResponseToDto createIssue(IssueRequestToDto requestTo) {
        ...
        var author = repository.findUserById(requestTo.userId())
                .orElseThrow(() -> new NotFoundException("Author with id " + requestTo.userId() + " not found"));
