...
public class UserService {
    ...
    @Transactional
    public UserResponseTo createUser(UserRequest requestTo) {
    ...
    @Transactional
    public UserResponseTo updateUser(Long id, UserRequest requestTo) {
        validateUserRequest(requestTo);
    ...
    private void validateUserRequest(UserRequest requestTo) {
        if (requestTo == null) {
