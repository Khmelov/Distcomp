...
public class CompositeIdCodec {
    ...
    private static final Map<Integer, String> CODE_TO_COUNTRY = COUNTRY_TO_CODE.entrySet().stream()
    ...
    public NoticeKey decode(long compositeId) {
        ...
        return new NoticeKey(country, issueId, id);
    }
}