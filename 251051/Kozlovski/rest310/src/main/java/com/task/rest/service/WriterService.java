...
public class WriterService {
    private final InMemoryRepository<Writer> writerRepository;
    private final WriterMapper writerMapper;

    public WriterService(InMemoryRepository<Writer> writerRepository, WriterMapper writerMapper) {
    ...
    public WriterResponseTo getWriterByTweetId(Long tweetId) {
        return writerRepository.findAll().stream()
                .filter(writer -> writerRepository.findByWriterId(writer.getId()).stream()
